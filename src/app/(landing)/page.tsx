  ...
  return (
    <>
        ...
        <MaxWidthWrapper className="text-center">
          <div className="relative mx-auto text-center flex flex-col items-center gap-10">
            ...
            <p className="text-base/7 text-gray-600 max-w-prose text-center text-pretty">
              PingPanda es la forma más sencilla de monitorear su SaaS. Obtener
              instantáneo notificaciones para{" "}
      ...
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20 text-center">
          <div>
            <h2 className="text-center text-base/7 font-semibold text-brand-600">
              ¿Por que PingPanda?
            </h2>
            <Heading>
              Manténgase a la vanguardia con información en tiempo real
            </Heading>
          </div>
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    Obtenga actualizaciones en tiempo real sobre tus ventas y
                    clientes
                  </p>
                </div>
            ...
            <div className="relative max-lg:row-start-1">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-brand-950 max-lg:text-center">
                    Seguimiento de cualquier evento
                  </p>
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    De nuevo usuario Al registrarse para realizar pagos
                    exitosos, PingPanda le notifica sobre todos los eventos
                    críticos en su SaaS.
                  </p>
                </div>
                <div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-lg:pt-10 sm:px-10lg:pb-2">
                  <Image
